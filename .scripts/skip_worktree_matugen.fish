...
set matugen_color_file_paths btop/themes/fufu-matugen.theme cava/themes/fufu-matugen gtk-3.0/colors.css \
    gtk-4.0/colors.css hypr/colors.conf kitty/themes/fufu-matugen.conf mako/mako-colors nvim/lua/matugen/matugen.lua \
    opencode/themes/fufu-matugen.json qt5ct/colors/fufu-matugen.conf qt6ct/colors/fufu-matugen.conf \
    kitty/current-theme.conf yazi/theme.toml wlogout/colors.css \
    wlogout/.scripts/recolor-icons.sh wlogout/icons/*.png obs-studio/themes/matugen.obt \
    AdwSteamGtk/custom.css fish/conf.d/50-fish-prompt.fish zen/chrome/colors.css waybar/colors.css \
    walker/colors.css snappy-switcher/themes/matugen.ini zathura/zathura-colors niri/colors.kdl
