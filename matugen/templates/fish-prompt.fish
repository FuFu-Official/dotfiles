...
set -U my_p_icon_arch {{colors.primary.default.hex_stripped}}
set -U my_p_icon_linux {{colors.on_surface.default.hex_stripped}}
set -U my_p_cwd {{colors.secondary.default.hex_stripped}}
set -U my_p_git {{colors.tertiary.default.hex_stripped}}
set -U my_p_mode_default {{colors.primary.default.hex_stripped}}
set -U my_p_mode_insert {{colors.secondary.default.hex_stripped}}
